...
assert(#captured_params == 14, "query should bind every aggregation parameter")
assert(captured_params[12] == 128.5955669, "longitude should be bound")
assert(captured_params[13] == 35.9235922, "latitude should be bound")
assert(captured_params[14] == 1500, "radius should be bound")
