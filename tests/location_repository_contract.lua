...
assert(captured_sql:find("geom::geography", 1, true), "query should preserve meter-based distance")
assert(#captured_params == 10, "query should bind every aggregation parameter")
assert(captured_params[8] == 128.5955669, "longitude should be bound")
assert(captured_params[9] == 35.9235922, "latitude should be bound")
assert(captured_params[10] == 1500, "radius should be bound")
